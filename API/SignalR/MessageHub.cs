...
namespace API.SignalR
{
    ...
    public class MessageHub : Hub
    {
        ...
        public override async Task OnConnectedAsync()
        {
            ...
            var message = await _messageRepository.GetMessageThread(
        ...
        public async Task SendMessage(CreateMessageDto createMessageDto)
        {
            ...
            var group = await _messageRepository.GetMessageGroup(gropuName);
        ...
        {
            var group = await _messageRepository.GetGroupForConnention(Context.ConnectionId);
